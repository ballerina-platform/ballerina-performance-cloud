        ...
        if (payload is json) {
            ...
            if (xmlPayload is xml) {
                ...
                if (response is http:Response) {
                    ...
                    log:printError("Error at transformation", 'error = response);
                ...
                log:printError("Error at transformation", 'error = xmlPayload);
                http:Response res = new;
                res.statusCode = 400;
            ...
            log:printError("Error at transformation", 'error = payload);
            http:Response res = new;
            res.statusCode = 400;
